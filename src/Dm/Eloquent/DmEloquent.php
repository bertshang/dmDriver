...
namespace Bertshang\Dameng\Eloquent;

use Bertshang\Dameng\DmConnection;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Builder;
use Bertshang\Dameng\Grammars\DmGrammar;
...
class DmEloquent extends Model
{
    ...
    protected function extractBinaries(&$attributes)
    {
        ...
        // extract binary fields to new array
        $binaries = [];
        if ($this->checkBinary($attributes) && $this->getConnection() instanceof DmConnection) {
     ...
     *
     * @return \Illuminate\Database\Query\Builder|\Yajra\Oci8\Query\DmBuilder
     */
