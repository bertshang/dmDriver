...
use Bertshang\Dameng\Schema\Trigger;
use Bertshang\Dameng\Schema\Sequence;
use Illuminate\Database\Grammar;
use Illuminate\Database\Connection;
use Doctrine\DBAL\Connection as DoctrineConnection;
use Bertshang\Dameng\Query\DmBuilder as QueryBuilder;
use Bertshang\Dameng\Schema\DmBuilder as SchemaBuilder;
use Doctrine\DBAL\Driver\OCI8\Driver as DoctrineDriver;
use Bertshang\Dameng\Query\Grammars\DmGrammar as QueryGrammar;
use Bertshang\Dameng\Query\Processors\DmProcessor as Processor;
use Bertshang\Dameng\Schema\Grammars\DmGrammar as SchemaGrammar;
...
class DmConnection extends Connection
{
     ...
     *
     * @return \Yajra\Oci8\Schema\DmBuilder
     */
     ...
     *
     * @param string $table
     * @return \Yajra\Oci8\Query\DmBuilder
     */
     ...
     *
     * @return \Illuminate\Database\Grammar|\Yajra\Oci8\Query\Grammars\DmGrammar
     */
     ...
     *
     * @param \Illuminate\Database\Grammar|\Yajra\Oci8\Query\Grammars\DmGrammar|\Yajra\Oci8\Schema\Grammars\DmGrammar $grammar
     ...
     *
     * @return \Illuminate\Database\Grammar|\Yajra\Oci8\Schema\Grammars\DmGrammar
     */
     ...
     *
     * @return \Yajra\Oci8\Query\Processors\DmProcessor
     */
